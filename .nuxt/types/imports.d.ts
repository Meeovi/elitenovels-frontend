...
declare global {
  ...
  const getUser: typeof import('../../app/utils/auth').getUser
  ...
  const isLoggedIn: typeof import('../../app/utils/auth').isLoggedIn
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly getUser: UnwrapRef<typeof import('../../app/utils/auth')['getUser']>
    ...
    readonly isLoggedIn: UnwrapRef<typeof import('../../app/utils/auth')['isLoggedIn']>
