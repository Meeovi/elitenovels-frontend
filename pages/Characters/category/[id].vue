<template>
    <v-card elevation="0">
        <div v-if="tag?.name === 'Gods and Goddesses'"><mythologybar /></div>
        <div v-else-if="tag?.name === 'Angels'"><mythologybar /></div>
        <div v-else-if="tag?.name === 'Demons'"><mythologybar /></div>
        <div v-else-if="tag?.name === 'Mythical Creatures'"><mythologybar /></div>
        <div v-else-if="tag?.name === 'Other Myths'"><mythologybar /></div>
        <div v-else-if="tag?.name === 'Magical'"><mythologybar /></div>
        <div v-else-if="tag?.name === 'Monsters'"><monsterbar /></div>
        <div v-else><characterbar /></div>
...
const { data: tagData } = await useAsyncData('tagData', () => {
